...
CREATE TABLE IF NOT EXISTS depositos_prestamos_raw (
    ...
    emae_desestacionalizado DECIMAL,
    ipc_nucleo DECIMAL,
    mora_irregular_pct DECIMAL,
    mora_incobrable_pct DECIMAL,
    mora_irregular_total_pct DECIMAL,
    mora_familias_pct DECIMAL,
    mora_empresas_pct DECIMAL,
    mora_pnfc_hasta_29_pct DECIMAL,
    mora_pnfc_de_30_a_64_pct DECIMAL,
    mora_pnfc_desde_65_pct DECIMAL,
    mora_pnfc_cooperativas_pct DECIMAL,
    mora_pnfc_fintech_pct DECIMAL,
    mora_pnfc_leasing_factoring_pct DECIMAL,
    mora_pnfc_otras_cadenas_pct DECIMAL,
    mora_pnfc_otras_tarjetas_pct DECIMAL,
    mora_pnfc_resto_pct DECIMAL,
    mora_pnfc_electrodomesticos_pct DECIMAL,
    mora_pnfc_tarjetas_pct DECIMAL,
    mora_pnfc_personales_pct DECIMAL,
    mora_pnfc_otras_asistencias_pct DECIMAL,
    fetched_at TIMESTAMP DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS depositos_prestamos_normalized (
    ...
    mora_irregular_pct DECIMAL,
    mora_incobrable_pct DECIMAL,
    mora_total_irregular_pct DECIMAL,
    mora_familias_pct DECIMAL,
    mora_empresas_pct DECIMAL,
    mora_pnfc_hasta_29_pct DECIMAL,
    mora_pnfc_de_30_a_64_pct DECIMAL,
